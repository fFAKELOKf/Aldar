...
const exampleStories = [
  ...
  },
  {
    ...
    prompt: "Т��рговец на рынке отказывается дать еду голодному путнику. Алдар Косе подходит и предлагает сделку - он расскажет три мудрости за обед. Торговец соглашается из любопытства. После еды Алдар рассказывает очевидные истины, и торговец понимает, что его перехитрили.",
